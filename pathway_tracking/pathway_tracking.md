...
marp: true
theme: marp-w3
footer:  https://bit.ly/SultanTrack
...
### *Gaining confidence to promise personal growth to members*
...
[https://bit.ly/SultanTrack](https://bit.ly/SultanTrack)
...
In this talk, we explore ways to be resilient as a club against risks related with digitization.

We explore how to we can safeguard the growth and development of our members. 

We explore how to transparently track our Toastmaster's so that we can support each other in moving forward and celebrate each other's achievements and victories.
...
1. Risks with using the Pathways Platform
2. Issues with tracking Path Completions
3. Concerns with repetitive Speech Projects 

# Features
1. You now have access the PDF version of the speech projects 
2. The template can be shared to officers and club members for tracking
3. We can now see what has been finished so we can adjust/ adapt speech projects


---

<div class="w3-display-middle w3-jumbo">
  3-minute Demo and Discussion
</div>
